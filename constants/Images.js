export const images = {
  ...
  dailyInspirationOne: require('../assets/images/di_1.png'),
...
export const tabBarIcons = {
  active: {
    Home: require('../assets/images/tabIcons/x-icon_red.png'),
    Brands: require('../assets/images/tabIcons/brands_red.png'),
  ...
  inactive: {
    ...
    Brands: require('../assets/images/tabIcons/brands.png'),
